import{_ as u}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as o,o as b,c as g,a as n,t as v,b as a,w as s,n as k,g as h,e as m,d as e}from"./app-Ds0QsEfe.js";const _={},f={id:"frontmatter-title-관련",tabindex:"-1"},y={class:"header-anchor",href:"#frontmatter-title-관련"},x={class:"table-of-contents"},B=n("hr",null,null,-1),w=m(`<h2 id="starting-with-moon-buggy-game" tabindex="-1"><a class="header-anchor" href="#starting-with-moon-buggy-game"><span>Starting with Moon-Buggy Game</span></a></h2><h3 id="step-1" tabindex="-1"><a class="header-anchor" href="#step-1"><span>Step 1</span></a></h3><p>To start containerizing our Application (Moon-buggy), we&#39;ll first create a new container using the UBI9 image as the base.</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>buildah from registry.access.redhat.com/ubi9/ubi
