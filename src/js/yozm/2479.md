...
description: 요즘 IT 블로그 - Javascript 관련 > 프론트엔드와 SOLID 원칙 살펴보기
category: 
  - JavaScript
  - TypeScript
  - React
...
head:
  - - meta:
    - property: og:title
      content: 요즘 IT 블로그 - Javascript 관련 > 프론트엔드와 SOLID 원칙 살펴보기
    - property: og:description
      content: 프론트엔드와 SOLID 원칙 살펴보기
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/js/yozm/2479.html
---
...
```component VPCard
{
  ...
  "link": "https://yozm.wishket.com/magazine/detail/2479/",
