...
head:
  - - meta:
    - property: og:title
      content: Jump to Spring Boot > 2-05. 리포지터리
...
> 파일명: <FontIcon icon="iconfont icon-folder"/>`/sbb/src/main/java/com/mysite/sbb/`<FontIcon icon="fa-brands fa-java"/>`QuestionRepository.java`
...
> 파일명: <FontIcon icon="iconfont icon-folder"/>`/sbb/src/main/java/com/mysite/sbb/`<FontIcon icon="fa-brands fa-java"/>`AnswerRepository.java`
...
> 파일명: <FontIcon icon="iconfont icon-folder"/>`/sbb/src/test/java/com/mysite/sbb/`<FontIcon icon="fa-brands fa-java"/>`SbbApplicationTests.java`
