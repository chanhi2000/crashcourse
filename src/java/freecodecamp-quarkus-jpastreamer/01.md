...
lang: ko-KR
title: 01. Setup
description: Java Web App with Quarkus and JPAStreamer > 01. Setup
tags: ["crashcourse", "java", "spring", "spring-boot" , "jdk", "wikidocs"]
meta:
  - name: Java Web App with Quarkus and JPAStreamer > 01. Setup
    content: 01. Setup
  - property: og:title
    content: 01. Setup
  - property: og:description
    content: Java Web App with Quarkus and JPAStreamer > 01. Setup
  - property: og:url
...
Then simply press “Generate your application” to download a project <FontIcon icon="iconfont icon-file"/>ZIP-file. 
...
Then either remove the fields `rating` and `special_features` from the <FontIcon icon="iconfont icon-file"/>`Film.class`, or improve the mappings to impose some restraints on the values as follows:
