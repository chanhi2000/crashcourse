...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/swift/swiftui-by-example/03-images-shapes-and-media.html
---
...
::: details How to draw images using Image views
...
::: details How to adjust the way an image is fitted to its space
...
::: details How to render images using SF Symbols
...
::: details How to render a gradient
...
::: details How to use images and other views as a backgrounds
...
::: details How to display solid shapes
...
::: details How to fill and stroke shapes at the same time
...
::: details How to draw part of a solid shape using `trim()`
...
::: details When should you use `ContainerRelativeShape`?
...
::: details How to play movies with `VideoPlayer`
...
::: details How to integrate `SpriteKit` using `SpriteView`
...
::: details How to load a remote image from a URL
...
::: details How to get custom colors and transparency with SF Symbols
...
::: details How to dynamically adjust the color of an SF Symbol
...
::: details How to let users select pictures using PhotosPicker
...
::: details How to let users import videos using PhotosPicker
