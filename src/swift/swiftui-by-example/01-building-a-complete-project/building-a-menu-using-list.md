...
description: SwiftUI by Example > Building a menu using List
category:
  - Swift
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: SwiftUI by Example > Building a menu using List
    - property: og:description
      content: Building a menu using List
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/swift/swiftui-by-example/01-building-a-complete-project/building-a-menu-using-list.html
---
...
```component VPCard
{
  ...
  "link": "/swift/swiftui-by-example/10-lists.md#working-with-lists",
  "logo": "https://www.hackingwithswift.com/favicon-96x96.png",
  "background": "rgba(54,94,226,0.2)"
}
```
