...
description: SwiftUI by Example > How to fix “Protocol 'View' can only be used as a generic constraint because it has Self or associated type requirements”
category:
  - Swift
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: SwiftUI by Example > How to fix “Protocol 'View' can only be used as a generic constraint because it has Self or associated type requirements”
    ...
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/swift/swiftui-by-example/25-appendix-a/how-to-fix-protocol-view-can-only-be-used-as-a-generic-constraint-because-it-has-self-or-associated-type-requirements.html
---
