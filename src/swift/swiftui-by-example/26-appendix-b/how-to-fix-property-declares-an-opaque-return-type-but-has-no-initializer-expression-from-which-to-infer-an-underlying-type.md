...
description: SwiftUI by Example > How to fix “Property declares an opaque return type, but has no initializer expression from which to infer an underlying type”
category:
  - Swift
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: SwiftUI by Example > How to fix “Property declares an opaque return type, but has no initializer expression from which to infer an underlying type”
    ...
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/swift/swiftui-by-example/25-appendix-a/how-to-fix-property-declares-an-opaque-return-type-but-has-no-initializer-expression-from-which-to-infer-an-underlying-type.html
---
