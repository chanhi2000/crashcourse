...
lang: ko-KR
title: Day 98
description: 100 Days of SwiftUI > Day 98
category:
  - Swift
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: 100 Days of SwiftUI > Day 98
...
__Today you have three topics to work through, in which you’ll add support for size classes, show more information about facilities, and let users mark favorite resorts.__
...
Create a new Swift file called <FontIcon icon="fa-brands fa-swift"/>`Facility.swift`, replace its Foundation import with SwiftUI, and give it this code:
...
Create a new Swift file called <FontIcon icon="fa-brands fa-swift"/>`Favorites.swift`, replace its Foundation import with SwiftUI, then give it this code:
...
__Tip__: As you can see, the `foregroundColor()` modifier works great here because our image uses SF Symbols.
