...
lang: ko-KR
title: Day 41
description: 100 Days of SwiftUI > Day 41
category:
  - Swift
tag: 
  - crashcourse
...
Let’s start simple and work our way up: make a new SwiftUI view called <FontIcon icon="fa-brands fa-swift"/> `MissionView.swift`. Initially this will just have a `mission` property so that we can show the mission badge and description, but shortly we’ll add more to it.
...
Put this code into <FontIcon icon="fa-brands fa-swift"/>`MissionView.swift` now:
