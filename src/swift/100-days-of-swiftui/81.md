...
lang: ko-KR
title: Day 81
description: 100 Days of SwiftUI > Day 81
category:
  - Swift
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: 100 Days of SwiftUI > Day 81
...
To try this out, start by adding an extra import near the top of <FontIcon icon="fa-brands fa-swift"/>`ContentView.swift`:
...
To try it out, open <FontIcon icon="fa-brands fa-swift"/>`ContentView.swift` and add this import to the top:
...
PS: You can read the source code for my simple extension right inside Xcode – just open the Sources > SamplePackage group and look for <FontIcon icon="fa-brands fa-swift"/>`SamplePackage.swift`. You’ll see it doesn’t do much!
