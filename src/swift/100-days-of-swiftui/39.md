...
That brings us to the end of the overview for this project, so please go ahead and reset <FontIcon icon="fas fa-dove"/>`ContentView.swift` to its original state.
