...
lang: ko-KR
title: Day 97
description: 100 Days of SwiftUI > Day 97
category:
  - Swift
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: 100 Days of SwiftUI > Day 97
...
Create a new Swift file called <FontIcon icon="fa-brands fa-swift"/>`Resort.swift`, then give it this code:
...
Instead, we’re going to load an array of resorts from JSON stored in our app bundle, which means we can re-use the same code we wrote for project 8 – the <FontIcon icon="fa-brands fa-swift"/>`Bundle-Decodable.swift` extension. If you still have yours, you can drop it into your new project, but if not then create a new Swift file called <FontIcon icon="fa-brands fa-swift"/>`Bundle-Decodable.swift` and give it this code:
