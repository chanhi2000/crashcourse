...
lang: ko-KR
title: Day 52
description: 100 Days of Swift > Day 52
category:
  - Swift
tag: 
  - crashcourse
...
Select your <FontIcon icon="fas fa-file-lines"/> `Main.storyboard` file to open Interface Builder, then embed the view controller inside a navigation controller.
