...
lang: ko-KR
title: Day 30
description: 🕊️100 Days of Swift > Day 30
...
Open <FontIcon icon="iconfont icon-file"/>`Main.storyboard` in Interface Builder, select the bottom flag, then <kbd>Ctrl</kbd>-drag from the flag to the white space directly below the flag – in the view controller itself. The direction you drag is important, so please drag straight down.
