...
lang: ko-KR
title: Day 60
description: 🕊️100 Days of Swift > Day 60
tags: ["crashcourse", "swift" , "paul-hudson" , "xcode", "appstore"]
meta:
  - name: 100 Days of Swift > Day 60
    content: Day 60
  - property: og:title
    content: Day 60
...
Today you’re going to meet a new Apple framework called MapKit, which is designed to make mapping almost instant in iOS apps. It handles fetching data and rendering, it handles scrolling and zooming, and it even handles placemarks, routes, and more – it’s incredible.
...
Put these lines into the `viewDidLoad()` method of <FontIcon icon="fas fa-dove"/>`ViewController.swift`:
