  ...
  '/cli/': [
    ...
    */
  ...
  ], '/misc/': [
    {
      ...
      children: [
        '/assets/misc/oracle-sql-db-tuning/README.md',
        '/assets/misc/oracle-sql-db-tuning/01a.md',
        '/assets/misc/oracle-sql-db-tuning/01b.md',
        '/assets/misc/oracle-sql-db-tuning/01c.md',
        '/assets/misc/oracle-sql-db-tuning/01d.md',
        '/assets/misc/oracle-sql-db-tuning/02a.md',
        '/assets/misc/oracle-sql-db-tuning/03a.md',
        '/assets/misc/oracle-sql-db-tuning/03b.md',
        '/assets/misc/oracle-sql-db-tuning/03c.md',
      ],
    }
  ]
});