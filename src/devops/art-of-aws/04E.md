...
description: 아마존 웹 서비스를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것! > 04E. 가상 스토리지를 제공하는 EBS
category:
  - AWS
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: 아마존 웹 서비스를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것! > 04E. 가상 스토리지를 제공하는 EBS
    - property: og:description
      content: 04E. 가상 스토리지를 제공하는 EBS
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/devops/art-of-aws/04E.html
---
