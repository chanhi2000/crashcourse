...
lang: ko-KR
title: 02B. 가용 영역
description: 아마존 웹 서비스를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것! > 02B. 가용 영역
category:
  - AWS
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: 아마존 웹 서비스를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것! > 02B. 가용 영역
    - property: og:description
      content: 02B. 가용 영역
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/devops/art-of-aws/02B.html
---
