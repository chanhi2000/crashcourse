...
description: 스타트업과 클라우드 컴퓨팅를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것! > 01C. 스타트업과 클라우드 컴퓨팅
category:
  - AWS
tag: 
  - crashcourse
...
head:
  - - meta:
    - property: og:title
      content: 스타트업과 클라우드 컴퓨팅를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것! > 01C. 스타트업과 클라우드 컴퓨팅
...
```component VPCard
{
  ...
  "desc": "스타트업과 클라우드 컴퓨팅를 다루는 기술 - 실무에서 필요한 AWS 클라우드의 모든 것!",
