...
```component VPCard
{
  "title": "4장 - 6.2. EBS 스냅샷으로 EBS 볼륨 생성하기",
  "desc": "아마존 웹 서비스를 다루는 기술",
...
```component VPCard
{
  "title": "4장 - 6.3. EBS 스냅샷으로 AMI 생성하기",
  "desc": "아마존 웹 서비스를 다루는 기술",
  "link": "https://pyrasis.com/book/TheArtOfAmazonWebServices/Chapter04/06/03",
  "logo": "https://pyrasis.com/favicon.ico",
  "background": "rgba(31,41,55,0.2)"
}
```
...
```component VPCard
{
  "title": "4장 - 6.4. EBS 스냅샷을 다른 리전으로 복사하기",
  "desc": "아마존 웹 서비스를 다루는 기술",
  "link": "https://pyrasis.com/book/TheArtOfAmazonWebServices/Chapter04/06/04",
  "logo": "https://pyrasis.com/favicon.ico",
  "background": "rgba(31,41,55,0.2)"
}
```
