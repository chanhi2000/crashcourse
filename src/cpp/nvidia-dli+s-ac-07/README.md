...
description: Scaling CUDA C++ Applications to Multiple Nodes | NVIDIA
...
head:
  - - meta:
    - property: og:title
      content: Scaling CUDA C++ Applications to Multiple Nodes | NVIDIA
    - property: og:description
      content: Scaling CUDA C++ Applications to Multiple Nodes | NVIDIA
    - property: og:url
      content: https://chanhi2000.github.io/crashcourse/cpp/nvidia-dli+s-ac-07/
---
...
```component VPCard
{
  ...
  "link": "https://courses.nvidia.com/courses/course-v1:DLI+S-AC-07+V1/",
